...
void ReducedNtuple<Base>::FillOutputTree(TTree* tree, const Systematic& sys, bool do_slim){
  ...
  if(!AnalysisBase<Base>::IsData()){
    ...
    m_elIDSFweight = AnalysisBase<Base>::GetElIDSFWeight(Electrons+LowPtElectrons, 0);
    m_elIDSFweight_up = AnalysisBase<Base>::GetElIDSFWeight(Electrons+LowPtElectrons, 1);
    m_elIDSFweight_down = AnalysisBase<Base>::GetElIDSFWeight(Electrons+LowPtElectrons, -1);
    m_elISOSFweight = AnalysisBase<Base>::GetElISOSFWeight(Electrons+LowPtElectrons, 0);
    m_elISOSFweight_up = AnalysisBase<Base>::GetElISOSFWeight(Electrons+LowPtElectrons, 1);
    m_elISOSFweight_down = AnalysisBase<Base>::GetElISOSFWeight(Electrons+LowPtElectrons, -1);
    m_elSIPSFweight = AnalysisBase<Base>::GetElSIPSFWeight(Electrons+LowPtElectrons, 0);
    m_elSIPSFweight_up = AnalysisBase<Base>::GetElSIPSFWeight(Electrons+LowPtElectrons, 1);
    m_elSIPSFweight_down = AnalysisBase<Base>::GetElSIPSFWeight(Electrons+LowPtElectrons, -1);
    m_elVLSFweight = AnalysisBase<Base>::GetElVLIDSFWeight(Electrons+LowPtElectrons, 0);
    m_elVLSFweight_up = AnalysisBase<Base>::GetElVLIDSFWeight(Electrons+LowPtElectrons, 1);
    m_elVLSFweight_down = AnalysisBase<Base>::GetElVLIDSFWeight(Electrons+LowPtElectrons, -1);
