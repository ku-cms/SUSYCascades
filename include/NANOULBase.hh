...
// Tue Feb 11 18:06:30 2025 by ROOT version 6.26/11
// from TTree Events/Events
// found on file: root://cmsxrootd.fnal.gov//store/mc/RunIISummer20UL17NanoAODv9/TTJets_DiLept_TuneCP5_13TeV-madgraphMLM-pythia8/NANOAODSIM/106X_mc2017_realistic_v9-v1/50000/75CB6752-05D5-5747-8F6B-3B368459B701.root
//////////////////////////////////////////////////////////
...
//#ifdef NANOULBase_cxx
inline NANOULBase::NANOULBase(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/mc/RunIISummer20UL17NanoAODv9/TTJets_DiLept_TuneCP5_13TeV-madgraphMLM-pythia8/NANOAODSIM/106X_mc2017_realistic_v9-v1/50000/75CB6752-05D5-5747-8F6B-3B368459B701.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/mc/RunIISummer20UL17NanoAODv9/TTJets_DiLept_TuneCP5_13TeV-madgraphMLM-pythia8/NANOAODSIM/106X_mc2017_realistic_v9-v1/50000/75CB6752-05D5-5747-8F6B-3B368459B701.root");
      }
...
inline NANOULBase::~NANOULBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

inline Int_t NANOULBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
inline Long64_t NANOULBase::LoadTree(Long64_t entry)
{
...
inline void NANOULBase::Init(TTree *tree)
{
...
inline void NANOULBase::ClearEvent(){
}

inline Bool_t NANOULBase::Notify()
{
...
inline void NANOULBase::Show(Long64_t entry)
{
...
inline Int_t NANOULBase::Cut(Long64_t entry)
{
