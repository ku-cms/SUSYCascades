...
class EventCount:
    ...
    def CleanDASDatasetOutputParsing(self, das_output):
        ...
        das_output = [dataset for dataset in das_output if 'JME' not in dataset and 'PUFor' not in dataset and 'PU35ForTRK' not in dataset and 'LowPU' not in dataset and 'PUMu4' not in dataset and 'BTV' not in dataset]
