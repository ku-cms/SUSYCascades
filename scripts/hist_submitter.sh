...
python3 scripts/condor_submit_nano_connect_histograms.py -list samples/NANO/Lists/Summer22_130X.list --verbose --privateMC
python3 scripts/condor_submit_nano_connect_histograms.py -list samples/NANO/Lists/Summer22EE_130X.list --verbose --privateMC
python3 scripts/condor_submit_nano_connect_histograms.py -list samples/NANO/Lists/Summer23_130X.list --verbose --privateMC
python3 scripts/condor_submit_nano_connect_histograms.py -list samples/NANO/Lists/Summer23BPix_130X.list --verbose --privateMC
